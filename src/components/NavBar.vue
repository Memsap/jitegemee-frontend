...
<v-app-bar-title>Jitegemee University</v-app-bar-title>
    ...
    <v-btn to="/login" color="indigo"> Log In</v-btn>
    <v-btn to="/apply" color="indigo"> Apply</v-btn>
    <v-btn to="/events" color="indigo"> Events</v-btn>
    <v-btn to="/studentlife" color="indigo"> Student Life</v-btn>
    <v-btn to="/library" color="indigo
    "> Library</v-btn>    
</v-app-bar>
